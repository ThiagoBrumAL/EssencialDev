...
function LoginScreen(){
    ...
    return (
        <div id="login-screen" className="w-full min-h-dvh flex md:flex-row flex-col">
            ...
            <section id="login-screen-div-two" className={`${theme ? "bg-slate-50" : "bg-slate-900"} w-full min-h-dvh flex items-center justify-between py-8 flex-col`}>
                ...
                <div id="container-theme" className="flex flex-col gap-4 items-center mt-[28px] sm:gap-12 sm:flex-row">
